        ...
        <div className="grid grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <img
              ...
              alt="SONA Travel And Tours Logo"
              className="h-[182px] w-[145px] mb-8"
            />
            <div className="space-y-4">
              <p className="text-[16px] font-semibold text-[#3d3d3d] text-center font-opensans">
                info@sonatraveltours.com
              </p>
              <div className="text-center">
                <span className="text-[16px] font-semibold text-[#3d3d3d] font-opensans">
                  (+977)9845122260
                </span>
                <span className="text-[16px] font-semibold text-[#0a639d] font-opensans">
                  {' '}
                </span>
                <span className="text-[16px] font-semibold text-[#3d3d3d] font-opensans">
                  (+977)9845230101
