  ...
  return (
    <header className="bg-white border-b border-[#ececec] h-[110px] flex items-center">
      <div className="w-full max-w-[1440px] mx-auto px-[75px] flex items-center justify-between">
        ...
        <Button
          variant="primary"
          className="bg-[#0a639d] text-white px-4 py-3 rounded-[12px] h-[60px] w-[139px] flex items-center justify-center space-x-2"
        >
          <img
            ...
            className="w-[24px] h-[24px]"
          />
          <span className="text-[20px] font-bold font-opensans">Sign Up</span>
        </Button>
      </div>
    </header>
  );
