...
const AboutUs = () => {
  ...
  const aboutSections = [
    ...
    },
    {
      ...
      content: `We offer comprehensive travel solutions including online booking, real-time bus tracking, multiple payment options, customer support, and route management. Our user-friendly app makes travel planning simple and convenient.`
    }
  ];
            ...
            <div className="relative mb-12">
              <div className="relative bg-white/60 backdrop-blur-xl rounded-3xl p-8 lg:p-12 border border-gray-200/40 shadow-2xl hover:shadow-3xl hover:scale-[1.01] transition-all duration-700 group">
                ...
                <div className="text-center">
                  <h2 className="text-3xl lg:text-4xl font-bold text-gray-800 mb-6 group-hover:text-blue-600 transition-colors duration-500">
