...
const FloatingActionBar = ({ handleSocialClick }) => {
  ...
  return (
    <>
      {/* Desktop Floating Action Bar - Right side for desktop */}
      <div className="hidden lg:block fixed right-3 top-1/2 transform -translate-y-1/2 z-50 md:right-4">
        <div
      ...
      <div className={`lg:hidden fixed bottom-0 left-0 right-0 z-50 transition-transform duration-300 ease-in-out ${
        ...
        <div 
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(255,255,255,0.25) 0%, rgba(255,255,255,0.18) 50%, rgba(255,255,255,0.30) 100%)',
            ...
            borderBottom: 'none',
            borderTop: '2px solid #ff8f1f',
            boxShadow: '0 -10px 40px rgba(0,0,0,0.1), 0 -5px 20px rgba(0,0,0,0.05), inset 0 1px 0 rgba(255,255,255,0.4)',
          }}
        >
          ...
          <div className="flex items-center justify-around max-w-md mx-auto">
            ...
            >
              ...
              <span className="text-xs font-medium text-gray-600 group-hover:text-blue-600">Home</span>
            </button>
            ...
            >
              ...
              <span className="text-xs font-medium text-gray-600 group-hover:text-gray-700">Call</span>
            </button>
            ...
            >
              ...
              <span className="text-xs font-medium text-gray-600 group-hover:text-orange-600">Routes</span>
            </button>
            ...
            >
              ...
              <span className="text-xs font-medium text-gray-600 group-hover:text-green-600">Chat</span>
            </button>
          </div>
        </div>
      </div>
