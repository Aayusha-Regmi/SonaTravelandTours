            ...
            <div className="relative h-full">
              <div className="relative bg-white/60 backdrop-blur-xl rounded-3xl p-8 lg:p-12 border border-gray-200/40 shadow-2xl hover:shadow-3xl hover:scale-[1.02] transition-all duration-700 group h-full flex flex-col">
                ...
                <div className="grid grid-cols-3 gap-6 mb-8 flex-grow">
                  ...
                  <a href="https://www.facebook.com/sonatraveltours" className="group/social">
                  ...
                  <a href="https://www.instagram.com/sonatravelandtours/" className="group/social">
                  ...
                  <a href="https://www.linkedin.com/company/sona-travel-and-tours/" className="group/social">
                ...
                <div className="space-y-4 flex-shrink-0">
                  ...
                  <a href="https://wa.me/9779802374215" className="flex items-center justify-center space-x-3 p-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl text-white font-bold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
